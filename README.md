...
تم تطويرها بواسطة المبرمج [Osman Salih](https://github.com/osmansalih) او [Snixrs](https://github.com/Snixrs)
...
لو عايز تساعد في تطوير اللغة بتقدر تساهم على GitHub سواء بـ Pull Requests أو انك تبلغ عن المشاكل.

## الترخيص

```
Powered By Havnix™
Developed By Osman Salih (AKA: Snixrs)
